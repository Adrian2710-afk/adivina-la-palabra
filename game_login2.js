...
function check(){
    ...
    if(answer==word){
     ...
     if(answer_turn=="player1"){
        ...
        document.getElementById("player_answer").innerHTML="turno de adivinar - "+ player2_name

      }else{
        answer_turn="player1";

        document.getElementById("player_answer").innerHTML="turno de adivinar - "+ player1_name
     }
